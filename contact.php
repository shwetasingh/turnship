<?php 
	...
	#Your e-mail address
	define("__TO__", "yours@domain.com");
	...
	//Get post data
	if(isset($_POST['name']) and isset($_POST['email']) and isset($_POST['message']) and isset($_POST['number']) and isset($_POST['subject'])){
		$name 	 = $_POST['name'];
		$mail 	 = $_POST['email'];
		$title_sj  = $_POST['subject'];
		$number = $_POST['number'];
		...
		if($name == '') {
			...
			echo json_encode(array('info' => 'error', 'msg' => "Please enter your subject."));
			exit();
		}else if($number == ''){
			...
			<body>
			  <table style="width: 500px; font-family: arial; font-size: 14px;" border="1">
				...
				<tr style="height: 32px;">
				  <th align="right" style="width:150px; padding-right:5px;">Number:</th>
				...
				<tr style="height: 32px;">
				  ...
				  <td align="left" style="padding-left:5px; line-height: 20px;">'. $title_sj .'</td>
				</tr>
				<tr style="height: 32px;">
